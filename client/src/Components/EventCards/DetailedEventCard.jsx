    ...
    return (
        <div>
            <div className='lg:mx-32'>
                ...
                <div className='mt-8'>
                    <h2 className='font-bold text-xl mb-2 text-center lg:text-left'>Event description</h2>
                    <p className='p-2 lg:p-0'>{event.eventDescription}</p>
                </div>
                {/* <div className='mt-8'>
                ...
                <div className='mt-8 mb-8'>
                    <h2 className='font-bold text-xl mb-2 text-center lg:text-left'>Event Organiser</h2>
                    <div>
                        <h4 className='text-center lg:text-left'>Organisation Name: <b>{event.organiser?.organisationName}</b></h4>
                        <h4 className='text-center lg:text-left'>Organisation Email: <b>{event.organiser?.organisationEmail}</b></h4>
                        {/* <div> */}
                            {/* <Link  className='bg-gray-300 w-full lg:w-60 pl-4 my-1 text-center lg:mx-0'
                             to={`org-profile/${event.organiser?._id}`}
                            >Know More</Link> */}
                        {/* </div> */}
                        <button type='button' className='bg-gray-300 w-full lg:w-60 pl-4 my-1 text-center lg:mx-0' onClick={()=>handleNavigate()}>
                            Know more
                        </button>
                    </div>
                </div>
                <div className='mt-8'>
                    <h2 className='font-bold text-xl mb-2 text-center lg:text-left'>Event Images</h2>
                    <div>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-6 md:grid-cols-4'>
                        ...
                        {
                           // console.log(event.images)
                             event.images.length===0 && <p className='text-md py-4 text-center lg:text-left'>No images to display</p>
                        }
                    </div>
