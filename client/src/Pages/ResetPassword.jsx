...
const ResetPassword = () => {
    ...
    const handleSubmit = async(e)=>{
        ...
        console.log('in forget pass',confimPassword)
...
{isSubmit && <p className='pt-5  text-green-600 font-medium text-lg text-center'>Password reset done . Kindly login with updated password.</p>}
               </form>
            </div>
        </div>
    </div>
